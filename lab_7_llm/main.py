...
class RawDataPreprocessor(AbstractRawDataPreprocessor):
    ...
    def transform(self) -> None:
        ...
        self._data = (
            ...
            .rename(columns={'EN': ColumnNames.SOURCE.value,
                             'DE': ColumnNames.TARGET.value})
            .reset_index(drop=True)
        )
        prefix = 'Translate from English to German:'
        self._data[ColumnNames.SOURCE.value] = prefix + self._data[ColumnNames.SOURCE.value]
...
class LLMPipeline(AbstractLLMPipeline):
    ...
    def infer_sample(self, sample: tuple[str, ...]) -> str | None:
        ...
        output_tokens = self._model.generate(tokens)
