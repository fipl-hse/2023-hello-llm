...
class RawDataPreprocessor(AbstractRawDataPreprocessor):
    ...
    def analyze(self) -> dict:
        ...
        dataset_analysis['dataset_sample_min_len'] = len(min(self._raw_data['text'], key=len))
        dataset_analysis['dataset_sample_max_len'] = len(max(self._raw_data['text'], key=len))
...
class LLMPipeline(AbstractLLMPipeline):
    ...
    def analyze_model(self) -> dict:
        ...
        model_info = {
            "input_shape": {"input_ids": list(input_data['input_ids'].shape),
    ...
    def _infer_batch(self, sample_batch: Sequence[tuple[str, ...]]) -> list[str]:
        ...
        tokens = tokenizer(sample_batch[0], max_length=self._max_length, padding=True,
    ...
    def run(self) -> dict | None:
        ...
        for metric in self._metrics:
            ...
            result = metric.compute(references=predictions['target'].to_list(),
                                    predictions=predictions['predictions'].to_list(), average="micro")
